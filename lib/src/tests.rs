...
mod tests {
    ...
    fn construct_basic_board() {
        let mut board = SimpleNumberlinkBoard::with_dims((3, 3));
    ...
    #[test]
    fn step_invalid() {
        let board = SimpleNumberlinkBoard::with_dims((3, 3));
        assert_eq!(board.step((0, 0), BoardTraverseDirection::UP), None);
    }

    #[test]
    fn step_valid() {
        let board = SimpleNumberlinkBoard::with_dims((5, 5));
        assert_eq!(board.step((4, 4), BoardTraverseDirection::LEFT), Some((3, 4)))
    }

    #[test]
    fn num_affiliations() {
        let mut board = SimpleNumberlinkBoard::with_dims((3, 5));
    ...
    fn solve_board() {
        {
            ...
            let mut board = SimpleNumberlinkBoard::with_dims((5, 5));
...
");
        }
        {
            ...
            let mut board = SimpleNumberlinkBoard::with_dims((12, 12));
